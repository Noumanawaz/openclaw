...
flowchart LR
  ...
  subgraph EX["Configured isolated execution (sandboxing off by default)"]
    direction TB
    SB["Sandbox: Docker, OpenShell, Podman, SSH"]
